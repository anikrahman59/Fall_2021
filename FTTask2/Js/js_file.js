...
var file = document.getElementById("file").value;
         ...
         if(document.getElementById("designation").checked == false && document.getElementById("designation2").checked == false && document.getElementById("designation3").checked == false)
         {
